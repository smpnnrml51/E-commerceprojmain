                                                ...
                                                <table class="w-full">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="bg-white border-b border-dashed dark:bg-gray-900 dark:border-gray-700/40">
                                                            ...
                                                            <td clas    s="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                                    20 Jun 2023
                                                                </td>
                                                            <td class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                                {{-- <span class="bg-green-600/5 text-green-600 text-[11px] font-medium px-2.5 py-0.5 rounded h-5">Success</span> --}}
                                                                <select class="bg-green-600/5 text-green-600 text-[11px] font-medium px-2.5 py-0.5 rounded h-5">
                                                                    <option value="success" class="text-green-600">Success</option>
                                                                    <option value="pending" class="text-yellow-600">Pending</option>
                                                                    <option value="cancel" class="text-red-600">Cancel</option>
                                                                </select>
                                                            </td>
                                                            {{-- <td class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                ...
                                                <table class="w-full">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="bg-white border-b border-dashed dark:bg-gray-900 dark:border-gray-700/40">
                                                            ...
                                                            <td class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                                <a class='text-brand-500 underline' href='/robotech/default/admin-order-details'>#369258</a>
                                                            </td>
                                                            <td class="p-3 text-sm font-medium whitespace-nowrap dark:text-white">
                                                                <div class="flex items-center">
                                                                    <img src="assets/images/users/avatar-2.png" alt="" class="me-2 h-8 inline-block">
                                                ...
                                                <table class="w-full">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="bg-white border-b border-dashed dark:bg-gray-900 dark:border-gray-700/40">
                                                            ...
                                                            <td class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                                <a class='text-brand-500 underline' href='/robotech/default/admin-order-details'>#998587</a>
                                                            </td>
                                                            <td class="p-3 text-sm font-medium whitespace-nowrap dark:text-white">
                                                                <div class="flex items-center">
                                                                    <img src="assets/images/users/avatar-2.png" alt="" class="me-2 h-8 inline-block">
