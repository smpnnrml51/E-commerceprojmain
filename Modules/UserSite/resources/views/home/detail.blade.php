                                        ...
                                        <div class="sm:col-span-12  md:col-span-12 lg:col-span-6 xl:col-span-6 text-center">
                                            <div id="img-container" class="w-[400px] text-center inline-block mx-auto">
                                                <img src="{{ asset('storage/' . explode('|', $product->filepond)[0]) }}"
                                                    alt="Product Image" class="inline-block">
                                            </div>
                                        </div>
                                ...
                                <div class="flex-auto ">
                                        ...
                                        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" aria-label="Tabs">
                                            ...
                                            <li class="me-2" role="presentation">
                                                <button
                                                    ...
                                                    role="tab" aria-controls="additional"
                                    ...
                                    <div id="myTabContent">
                                        <div class="active  p-4 bg-gray-50 rounded-lg dark:bg-gray-800" id="description"
                                            ...
                                            <p class="text-base text-slate-700 mb-3">Introducing Robotech, where innovation
                                                meets style to redefine your footwear experience.<br></p>

                                            <p class="text-base text-slate-700 mb-3">At Robotech, we believe that every
                                                step you take should be a statement of comfort, quality, and fashion-forward
                                                design. Our collection of shoes is meticulously crafted to not only elevate
                                                your style but also provide the utmost comfort for your feet.<br></p>

                                            <p class="text-base text-slate-700 mb-3"><b>Unparalleled Comfort:</b> We
                                                understand that comfort is non-negotiable when it comes to footwear. That's
                                                why we've invested in the latest ergonomic technologies to ensure that each
                                                pair of Robotech shoes feels like a cloud beneath your feet. Whether you're
                                                navigating the urban jungle or embarking on a weekend adventure, our shoes
                                                are engineered to keep you comfortable throughout the day.<br></p>

                                            <p class="text-base text-slate-700 mb-3"><b>Premium Quality:</b> We're
                                                committed to excellence, which is why we use only the finest materials in
                                                our shoe production. From luxurious leathers to durable synthetics, every
                                                pair of Robotech shoes is built to withstand the test of time. Our
                                                meticulous craftsmanship and attention to detail guarantee that you're
                                                investing in shoes that will serve you well for years to come.<br></p>

                                            <p class="text-base text-slate-700 mb-3"><b>Sustainable Fashion:</b> At
                                                ...
                                                process, using eco-friendly materials and minimizing waste. When you choose
                                                Robotech, you're not only choosing style; you're making a responsible choice
                                                for the planet.<br></p>

                                            <p class="text-base text-slate-700 mb-3"><b>Versatile Style:</b> Whether you're
                                                looking for sleek and sophisticated business attire or something casual for
                                                your weekend adventures, Robotech offers a wide range of styles to suit
                                                every occasion. From timeless classics to bold, statement-making designs,
                                                our collection has something for everyone.<br></p>

                                            <p class="text-base text-slate-700 mb-3"><b>Affordable Luxury:</b> We believe
                                                that luxury should be accessible. That's why we've worked tirelessly to
                                                provide you with high-quality shoes at prices that won't break the bank.
                                                Elevate your wardrobe without compromising your budget.<br></p>

                                            <p class="text-base text-slate-700 mb-3"><b>Your Journey, Your Style:</b> We
                                                understand that every individual's journey is unique, and your style should
                                                reflect that. That's why Robotech offers a wide range of sizes and
                                                customizable options to ensure that you find the perfect fit that
                                                complements your unique personality and lifestyle.<br></p>

                                            <p class="text-base text-slate-700 mb-3">Join us on this exciting journey as we
                                                redefine the way you experience footwear. Discover the perfect balance of
                                                comfort, quality, and style with Robotech. Step into a world where every
                                                step matters.<br></p>
                                                            ...
                                                            <table class="table border rounded-lg w-full">
                                                                ...
                                                                <tbody>
                                                                    <tr
                                                                        ...
                                                                        <td class="p-4 mb-0">Robotech air zoom terra kiger
                                                                            7</td>
                                                                    </tr>
                                                                    <tr
                                                                        class="bg-white border-b border-dashed dark:bg-gray-900 dark:border-gray-700/40">
                                        ...
                                        <div class="hidden p-4 bg-gray-50 rounded-lg dark:bg-gray-800" id="reviews"
                                            ...
                                            <div class="grid md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12 gap-4">
                                                <div class="sm:col-span-12  md:col-span-6 lg:col-span-6 xl:col-span-6 ">
                                                    <div class=" w-full relative">
                                                        <div class="flex-auto p-4 text-center">
                                                            <h3 class="my-4 font-semibold text-[34px] dark:text-slate-200">
                                                                4.8</h3>
                                                            <p class="text-gray-600 font-semibold dark:text-slate-400">
                                                                Overall Rating</p>
                                                            <div class="">
                                                                <i
                                                ...
                                                <div class="sm:col-span-12  md:col-span-6 lg:col-span-6 xl:col-span-6 ">
                                                    <div class=" w-full relative">
                                                        <div class="flex-auto">
                                                            <h5 class="text-slate-800 text-3xl font-semibold">Be the first
                                                                to review “Robotech Shoe”</h5>
                                                            <form action="">
                                                                <div class="mb-2">
                                                                ...
                                                                <div class="starability-basic min-h-[30px] block mb-2">
                                                                    ...
                                                                    <input type="radio" id="rate4" name="rating"
                                                                        value="4" />
                                                                    <label for="rate4" title="Very good">4
                                                                        stars</label>
