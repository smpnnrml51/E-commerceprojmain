                            ...
                            <div class="flex-auto p-0 md:p-4">
                                <div class="mb-2">
                                    <label for="Category_title"
                                        class="font-medium text-sm text-slate-600 dark:text-slate-400">Category title</label>
                                ...
                                <div class="mb-2">
                                    <label for="Category_Number"
                                        class="font-medium text-sm text-slate-600 dark:text-slate-400">Category Number</label>
